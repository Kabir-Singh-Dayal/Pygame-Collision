...
class sprite(pygame.sprite.Sprite):
    ...
    def move(self, xch, ych):
        ...
        self.rect.y=max(min(self.rect.y+ych, Width-self.rect.height),0)
...
s2.rect.x, s1.rect.y=random.randint(0,Width-s1.rect.width), random.randint(0, Height-s1.rect.height)
all_sprites.add(s2)
running = True
won = False
